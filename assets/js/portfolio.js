const portfolios = [
  ...
  },
  {
    ...
    imageUrl: 'ipo',
    desc:
      'IPO 현황을 한눈에 볼수 있는 표와 캘린더로 구성된 하이브리드 애플리케이션 프로젝트의 프론트엔드개발을 담당하였습니다.\nAnguar 기반으로, ionic framework와 Typescript를 사용하여,을 구현하였습니다.'
  },
  {
    name: '삶터',
    companyName: '도도원',
    ...
    imageUrl: 'dodo',
    desc:
      '현장에서 근무하는 근로자들의 출퇴근 관리 시스템 앱프로젝트의 화면개발을 담당하였습니다.\nIonic framwork를 기반으로 관리자/사용자 앱 화면 개발을 진행하였습니다.'
  },
  {
    name: 'HEDING',
    companyName: '더라이징스타',
    ...
    imageUrl: 'heding',
    desc:
      '공고 전달 기반 인재 매칭 플랫폼 앱 프로젝트의 프론트엔드 개발을 담당하였습니다.\ngulp를 활용하여 업무효율화를 높여 반응형 웹페이지 퍼블리싱을 담당하였습니다.'
  },
  {
    name: '넥스트컬쳐',
    companyName: '넥스트컬쳐',
  ...
  },
  {
    ...
    imageUrl: 'sk',
    desc:
      'Btv셋탑 및 삼성 기기에 설치하는  앱 프로젝트의 화면 개발을 담당하였습니다. \n html/css/javascipt를 활용하고, 모듈화 작업을 하였습니다.'
  },
  {
    name: 'CJ헬로비전 Alaska',
    companyName: 'CJ',
    ...
    desc:
      '클라우드시스템을 이용한 IPTV 기반의 웹 어플리케이션 프로젝트의 화면 개발을 담당하였습니다. \n html/css/javascipt를 활용하고, 모듈화 작업을 하였습니다.'
  }
];
